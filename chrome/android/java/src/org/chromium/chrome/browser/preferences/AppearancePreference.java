...
public class AppearancePreference extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.appearance_preferences_themes);
        mAppearanceAdapter = new AppearanceAdapter(getActivity());
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mListView.setAdapter(mAppearanceAdapter);
    ...
    public void onStart() {
        super.onStart();
        mAppearanceAdapter.start();
    }

    @Override
    public void onStop() {
        super.onStop();
        mAppearanceAdapter.stop();
    }
