...
// Based on frameworks/base/core/java/android/preference/NightModeSeekBarPreference.java,
 ...
 */
public class NightModeSeekBarPreference extends Preference implements OnSeekBarChangeListener {
     ...
     */
    public NightModeSeekBarPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mMin = 0.85f;
        mMax = 1.15f;
        mStep = 0.01f;
