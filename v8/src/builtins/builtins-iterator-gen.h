...
class IteratorBuiltinsAssembler : public CodeStubAssembler,public IteratorBuiltinsFromDSLAssembler  {
 public:
 ...
 TNode<Object> IteratorStep(Node* context, const IteratorRecord& iterator,
	     ...
	     return UncheckedCast<Object>(IteratorStep(context, iterator, if_done, fast_iterator_result_map));
	       }
