...
/** Tests for {@link FeedSchedulerApiImpl}. */
@RunWith(RobolectricTestRunner.class)
public class FeedSchedulerApiImplTest extends SchedulerConformanceTest {
  ...
  public void setup() {
    initMocks(this);
    scheduler = new FeedSchedulerApiImpl(threadUtils);
  }
}
