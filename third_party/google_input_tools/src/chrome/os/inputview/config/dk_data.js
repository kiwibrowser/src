...
(function() {
  ...
  var data = i18n.input.chrome.inputview.content.util.createData(
      keyCharacters, viewIdPrefix_, true, true, keyCodes, 'dk.compact.qwerty');
  data['id'] = 'dk';
  ...
  letterKeysetSpec[keysetSpecNode.ID] = 'dk.compact.qwerty';
  ...
  symbolKeysetSpec[keysetSpecNode.ID] = 'dk.compact.symbol';
  ...
  var moreKeysetSpec = {};
  moreKeysetSpec[keysetSpecNode.ID] = 'dk.compact.more';
  ...
  numberKeysetSpec[keysetSpecNode.ID] = 'dk.compact.numberpad';
  ...
  var phoneKeysetSpec = {};
  phoneKeysetSpec[keysetSpecNode.ID] = 'dk.compact.phonepad';
