    ...
    LayoutBlockFlow {BODY} at (8,8) size 784x584
      LayoutBlockFlow {DIV} at (0,0) size 784x220 [border: (4px solid #0000FF)]
        LayoutBlockFlow {DIV} at (20,20) size 744x69
          ...
          LayoutText {#text} at (100,48) size 219x20
            text run at (100,48) width 219: "Test typing at the end of a list."
        ...
        LayoutBlockFlow {DIV} at (20,110) size 744x90
          ...
          LayoutText {#text} at (100,69) size 417x20
            text run at (100,69) width 417: "Typed text should appear after (on the line below) the list."
