    ...
    LayoutBlockFlow {body} at (8,16) size 784x178
      LayoutBlockFlow {p} at (0,0) size 784x20
        LayoutText {#text} at (0,0) size 284x19
          text run at (0,0) width 284: "In this test, the THEAD text should be justified."
      LayoutTable {table} at (0,36) size 300x142 [border: (1px outset #808080)]
        LayoutTableSection {thead} at (1,1) size 298x88
          LayoutTableRow {tr} at (0,2) size 298x84
            LayoutTableCell {td} at (2,2) size 294x84 [border: (1px inset #808080)] [r=0 c=0 rs=1 cs=1]
        ...
        LayoutTableSection {tfoot} at (1,115) size 298x26
        ...
        LayoutTableSection {tbody} at (1,89) size 298x26
          LayoutTableRow {tr} at (0,0) size 298x24
            LayoutTableCell {td} at (2,0) size 294x24 [border: (1px inset #808080)] [r=0 c=0 rs=1 cs=1]
