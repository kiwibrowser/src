...
To generate a key:
    ...
    keytool -genkey -v -keystore ~/chromium/keystore.jks -alias production -keyalg RSA -keysize 2048 -validity 10000 -keypass HERE_YOUR_ANDROID_KEYSTORE_PASSWORD -storepass HERE_YOUR_ANDROID_KEYSTORE_PASSWORD
